...
def main(argv):
    ...
    outer = MIMEMultipart()
    outer['Subject'] = 'Subject is not mentioned while composing'
    outer['To'] = COMMASPACE.join(recipients)
    outer['From'] = sender
    body= "No mail body part is included !"
    mailbody = MIMEText(body, 'plain')
    outer.attach(mailbody)
    ...
    try:
      ...
      #python email3.py -f copyblogdown@gmail.com -p fantastic -t anurajram@gmail.com -s test -a scan.txt
        #sys.exit(2)
    ...
    for opt, arg in opts:
          if opt == '-h':
             ...
             attachments = arg.split(",")
             print(attachments)
             #attachments.append(arg)# = arg
    
    # Add the attachments to the message
    #print (sender,gmail_password,recipients[0],outer['Subject'],attachments)
    #print (sender,gmail_password,recipients[1],outer['Subject'],attachments)
